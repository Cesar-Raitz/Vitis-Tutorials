...
This is all done through the TCL script located `sw/vck_190_v1_0_pfm.tcl`. In this section you will review important aspects of the `vck_190_v1_0_pfm.tcl` script used to generate the Vitis project. Open this script, review the comments, follow the notes in the next sections of this module.
